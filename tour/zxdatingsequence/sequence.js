...
const secondSequenceImages = [];
const thirdSequenceImages = [];

//for (let i = 0; i <= 59; i ++) {
// firstSequenceImages.push(`${`00${i}`.slice(-3)}.jpg`);
//}
for (let i = 0; i <= 70; i++) {
    secondSequenceImages.push(`${`000${i}`.slice(-3)}.jpg`);
}
//for (let i = 0; i <= 74; i ++) {
//  thirdSequenceImages.push(`${`00${i}`.slice(-3)}.jpg`);
//}
...
const firstSequence = new ScrollSequence({
  ...
  imagesRoot: 'sequence1b/',
  priorityFrames: [0, 5, 10, 20, 40, 60, 90],
  cover: true,
  starts: 'in',
  ends: 'in'
});
*/
const secondSequence = new ScrollSequence({
    container: '.second-sequence',
    scrollWith: '.second-container',
    images: secondSequenceImages,
    imagesRoot: '/tour/zxdatingsequence/sequence2c/',
    priorityFrames: [0, 5, 10, 20, 40, 60, 90],
    cover: true,
    starts: 'out',
    ends: 'in'
...
/*
const thirdSequence = new ScrollSequence({
  container: '.third-sequence',
  scrollWith: '.third-container',
  images: thirdSequenceImages,
  imagesRoot: 'sequence3b/',
  priorityFrames: [0, 5, 10, 20, 40, 60, 90],
  cover: true,
  starts: 'in',
  ends: 'in'
